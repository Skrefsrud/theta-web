...
export function ThematicTiles() {
  ...
  return (
    <section className="relative py-16 md:py-20 overflow-hidden">
      ...
      <div className="absolute right-1/4 top-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-gradient-radial from-cyan-500/10 via-purple-500/5 to-transparent blur-[100px] pointer-events-none" />
      ...
      <div className="relative container mx-auto px-6 md:px-12">
        ...
        <div className="max-w-4xl mx-auto bg-gradient-to-br from-white/[0.02] to-white/[0.05] backdrop-blur-sm rounded-3xl border border-white/10 shadow-[0_20px_80px_rgba(0,0,0,0.4)] p-8 md:p-12">
          ...
          <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-cyan-500/20 via-transparent to-purple-500/20 opacity-50 blur-xl pointer-events-none" />

          <div className="relative space-y-8 md:space-y-12">
            {tiles.map((tile, index) => (
              <div
                key={index}
                className="group relative bg-[#0f0f11]/60 backdrop-blur-md rounded-2xl border border-white/10 p-8 md:p-10 transition-all duration-700 ease-in-out hover:scale-105 hover:shadow-[0_8px_48px_rgba(6,182,212,0.3)] hover:border-cyan-500/30"
              >
                {/* Hover glow effect */}
